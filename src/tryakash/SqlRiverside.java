...
public class SqlRiverside extends PApplet
{
	public static Connection c = null;
	public  static Statement stmt = null;
	public static String dbaseloc = "/Users/akash/Documents/eclipseWorkspace/RFIDLabReaderFinal/";
  public static void main( String args[] )
  {
	  SqlRiverside tmpObj = new SqlRiverside();
	 tmpObj.createDBase();
	  
	 // tmpObj.createRecord();
	 tmpObj.AddSQLDbase("Riverside3.csv");
	  //deleteRecords();
	 tmpObj.viewRecords();
  ...
  public void createDBase()
  {
	  ...
	  if(file.exists()) //here's how to check
	    ...
	    try {
	        ...
	        c = DriverManager.getConnection("jdbc:sqlite:"+dbaseloc+"rfid.db");
...
//	        stmt.executeUpdate(sql);
  ...
  try {
     ...
     // System.out.println("Opened database successfully");
      ...
      while ( rs.next() ) {
         ...
         double age  = rs.getFloat("LATITUDE");
         String  address = rs.getString("SIGN");
         float salary = 0.0f;
  ...
  private  void AddSQLDbase(String fileName) {
      ...
      for (String row : rows) {
          ...
          if (columns.length == 7 && !columns[6].equals("GPSLocation")) {
             ...
             // assetEPC.put(tmpObj.epcTag, columns[1]);
              //(double x, double y, String epc, String sgn, int asset)
        //  	 sql = "INSERT INTO COMPANY (ID,NAME,AGE,ADDRESS,SALARY) " +
//   	              "VALUES (2, 'Akash', 25, 'Texas', 15000.00 );"; 
//   	        stmt.executeUpdate(sql);
          	
//            String sql = "CREATE TABLE IF NOT EXISTS RFID " +
//                    "(ASSET INT PRIMARY KEY     NOT NULL," +
//                    " EPCTAG           TEXT    NOT NULL, " + 
...
//          	
   ...
   //
          	...
          	sql = "INSERT INTO RFID (ASSET,EPCTAG,LATITUDE,LONGITUDE,SIGN)"+ 
